...
_**Edit June 3rd 2019:** It was [pointed out to me](https://twitter.com/ztnelboKyrreihT/status/1135734895836196864) that the code example I was using was infact referencing inheritance and not the cascade, technically. Doh! So I've switched the example to actually show the cascade this time, but the article still holds the same conclustion and point. Just goes to show why CSS is so tricky to handle 😉_
